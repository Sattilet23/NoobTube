...
<table width="790" align="center" cellpadding="0" cellspacing="0" border="0">
	<tr valign="top">
		...
		<form action="functions/vid_uploader.php" method="post" enctype="multipart/form-data">
<label for="ch">Channels:</label>
  ...
  <label for="vname">Title:</label>
    <input type="text" id="vname" name="vname" size="40"><br>
	<br>
	 <label for="vdesc">Description:</label>
    <input type="text" class="vdesc" id="vdesc" name="vdesc" size="60"><br>
	<br>
	<label for="tag">Tag:</label>
    <input type="text" id="tag" name="tag" size="40"><br>
