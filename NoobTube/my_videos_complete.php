...
<div class="pageTitle">Video Uploaded</div>
<table width="790" align="center" cellpadding="0" cellspacing="0" border="0">
	<tr valign="top">
		<td style="padding-right: 15px;" width="510">
		
		<p>Your Video has been uploaded and is able to be viewed at this adderess:<p>
		<br><?php	echo "http://$_SERVER[HTTP_HOST]/noobtube/";	?>
