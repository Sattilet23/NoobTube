...
<table align="center" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td><a href="profile.php?user=<?php echo $_GET['user']; ?>">Profile</a></td>
...
$sql = "SELECT id, title, creator, tag, date, vdesc, views FROM videos WHERE creator = '{$_SESSION['login_user']}'";
