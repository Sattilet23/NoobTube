		...
		<table width="100%" cellpadding="5" cellspacing="0" border="0">
			...
			<input type="hidden" name="field_command" value="login_submit">
				...
				<tr>
					...
					<td><input type="submit"  name="login1" value="Log In"></td>
				</tr>
				<tr>
...
$sql = "SELECT username, password, id, isbanned, ismod FROM user WHERE username = '$myusername' and password = '$mypassword' and isbanned = '0'";
